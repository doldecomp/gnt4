...
/* 801F5CBC 001F2CBC  C8 42 C7 B8 */	lfd f2, lbl_8027C458@sda21(r2)
/* 801F5CC0 001F2CC0  7C 63 20 78 */	andc r3, r3, r4
/* 801F5CC4 001F2CC4  90 01 00 0C */	stw r0, 0xc(r1)
/* 801F5CC8 001F2CC8  C0 62 C7 C0 */	lfs f3, lbl_8027C460@sda21(r2)
...
/* 801F5CF4 001F2CF4  C8 42 C7 C8 */	lfd f2, lbl_8027C468@sda21(r2)
...
/* 801F5D08 001F2D08  C0 02 C7 D0 */	lfs f0, lbl_8027C470@sda21(r2)
/* 801F5D0C 001F2D0C  7C 7D 1B 78 */	mr r29, r3
/* 801F5D10 001F2D10  C8 42 C7 C8 */	lfd f2, lbl_8027C468@sda21(r2)
...
/* 801F5D38 001F2D38  C0 42 C7 AC */	lfs f2, lbl_8027C44C@sda21(r2)
/* 801F5D3C 001F2D3C  C0 22 C7 D4 */	lfs f1, lbl_8027C474@sda21(r2)
...
/* 801F5D50 001F2D50  C8 42 C7 C8 */	lfd f2, lbl_8027C468@sda21(r2)
...
/* 801F5D68 001F2D68  C8 42 C7 C8 */	lfd f2, lbl_8027C468@sda21(r2)
...
/* 801F5D80 001F2D80  C0 02 C7 D0 */	lfs f0, lbl_8027C470@sda21(r2)
/* 801F5D84 001F2D84  7C 77 1B 78 */	mr r23, r3
/* 801F5D88 001F2D88  C8 42 C7 C8 */	lfd f2, lbl_8027C468@sda21(r2)
...
/* 801F5DAC 001F2DAC  C8 42 C7 C8 */	lfd f2, lbl_8027C468@sda21(r2)
...
/* 801F5DD0 001F2DD0  C0 02 C7 A8 */	lfs f0, lbl_8027C448@sda21(r2)
...
/* 801F5DE4 001F2DE4  C0 E2 C7 AC */	lfs f7, lbl_8027C44C@sda21(r2)
...
/* 801F5E00 001F2E00  C8 22 C7 B8 */	lfd f1, lbl_8027C458@sda21(r2)
...
/* 801F5E20 001F2E20  C0 02 C7 A8 */	lfs f0, lbl_8027C448@sda21(r2)
...
/* 801F5E3C 001F2E3C  C0 62 C7 B0 */	lfs f3, lbl_8027C450@sda21(r2)
...
/* 801F5EE4 001F2EE4  C8 62 C7 B8 */	lfd f3, lbl_8027C458@sda21(r2)
...
/* 801F5EF8 001F2EF8  C0 02 C7 A8 */	lfs f0, lbl_8027C448@sda21(r2)
/* 801F5EFC 001F2EFC  EC 3D 00 72 */	fmuls f1, f29, f1
/* 801F5F00 001F2F00  C0 A2 C7 AC */	lfs f5, lbl_8027C44C@sda21(r2)
...
/* 801F5F18 001F2F18  C0 42 C7 B0 */	lfs f2, lbl_8027C450@sda21(r2)
...
/* 801F5FA8 001F2FA8  C8 62 C7 B8 */	lfd f3, lbl_8027C458@sda21(r2)
...
/* 801F5FBC 001F2FBC  C0 82 C7 AC */	lfs f4, lbl_8027C44C@sda21(r2)
...
/* 801F5FD4 001F2FD4  C0 22 C7 B0 */	lfs f1, lbl_8027C450@sda21(r2)
...
lbl_801F6048:
/* 801F6048 001F3048  C0 02 C7 A8 */	lfs f0, lbl_8027C448@sda21(r2)
...
/* 801F605C 001F305C  C0 02 C7 AC */	lfs f0, lbl_8027C44C@sda21(r2)
...
/* 801F6078 001F3078  C8 62 C7 B8 */	lfd f3, lbl_8027C458@sda21(r2)
...
/* 801F60CC 001F30CC  C0 22 C7 A8 */	lfs f1, lbl_8027C448@sda21(r2)
...
/* 801F619C 001F319C  C8 62 C7 B8 */	lfd f3, lbl_8027C458@sda21(r2)
...
/* 801F61B0 001F31B0  C0 A2 C7 AC */	lfs f5, lbl_8027C44C@sda21(r2)
...
/* 801F61C8 001F31C8  C0 42 C7 B0 */	lfs f2, lbl_8027C450@sda21(r2)
/* 801F61CC 001F31CC  C0 02 C7 D8 */	lfs f0, lbl_8027C478@sda21(r2)
