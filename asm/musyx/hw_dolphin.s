...
/* 801FBF90 001F8F90  88 AD 93 70 */	lbz r5, lbl_80277C90@sda21(r13)
/* 801FBF94 001F8F94  80 6D 93 6C */	lwz r3, lbl_80277C8C@sda21(r13)
...
/* 801FBFB8 001F8FB8  98 AD 93 70 */	stb r5, lbl_80277C90@sda21(r13)
...
/* 801FBFCC 001F8FCC  90 6D 93 5C */	stw r3, lbl_80277C7C@sda21(r13)
/* 801FBFD0 001F8FD0  80 0D 93 68 */	lwz r0, lbl_80277C88@sda21(r13)
/* 801FBFD4 001F8FD4  28 00 00 00 */	cmplwi r0, 0
/* 801FBFD8 001F8FD8  41 82 00 38 */	beq lbl_801FC010
/* 801FBFDC 001F8FDC  80 0D 93 60 */	lwz r0, lbl_80277C80@sda21(r13)
...
/* 801FBFEC 001F8FEC  90 0D 93 60 */	stw r0, lbl_80277C80@sda21(r13)
/* 801FBFF0 001F8FF0  4B F6 DB 7D */	bl OSEnableInterrupts
/* 801FBFF4 001F8FF4  81 8D 93 74 */	lwz r12, lbl_80277C94@sda21(r13)
...
/* 801FC008 001F9008  90 0D 93 60 */	stw r0, lbl_80277C80@sda21(r13)
/* 801FC00C 001F900C  48 00 00 0C */	b lbl_801FC018
lbl_801FC010:
/* 801FC010 001F9010  38 00 00 01 */	li r0, 1
/* 801FC014 001F9014  90 0D 93 64 */	stw r0, lbl_80277C84@sda21(r13)
lbl_801FC018:
...
/* 801FC02C 001F902C  90 0D 93 68 */	stw r0, lbl_80277C88@sda21(r13)
/* 801FC030 001F9030  90 0D 93 58 */	stw r0, lbl_80277C78@sda21(r13)
...
/* 801FC048 001F9048  90 6D 93 68 */	stw r3, lbl_80277C88@sda21(r13)
/* 801FC04C 001F904C  80 0D 93 64 */	lwz r0, lbl_80277C84@sda21(r13)
...
/* 801FC05C 001F905C  90 0D 93 64 */	stw r0, lbl_80277C84@sda21(r13)
/* 801FC060 001F9060  80 0D 93 60 */	lwz r0, lbl_80277C80@sda21(r13)
/* 801FC064 001F9064  28 00 00 00 */	cmplwi r0, 0
/* 801FC068 001F9068  40 82 00 24 */	bne lbl_801FC08C
/* 801FC06C 001F906C  90 6D 93 60 */	stw r3, lbl_80277C80@sda21(r13)
/* 801FC070 001F9070  4B F6 DA FD */	bl OSEnableInterrupts
/* 801FC074 001F9074  81 8D 93 74 */	lwz r12, lbl_80277C94@sda21(r13)
...
/* 801FC088 001F9088  90 0D 93 60 */	stw r0, lbl_80277C80@sda21(r13)
lbl_801FC08C:
...
/* 801FC0A4 001F90A4  38 6D 93 50 */	addi r3, r13, lbl_80277C70@sda21
...
/* 801FC0E8 001F90E8  90 6D 93 6C */	stw r3, lbl_80277C8C@sda21(r13)
...
/* 801FC0FC 001F90FC  80 6D 93 6C */	lwz r3, lbl_80277C8C@sda21(r13)
...
/* 801FC114 001F9114  90 0D 93 64 */	stw r0, lbl_80277C84@sda21(r13)
/* 801FC118 001F9118  38 63 BF 80 */	addi r3, r3, salCallback@l
/* 801FC11C 001F911C  90 8D 93 68 */	stw r4, lbl_80277C88@sda21(r13)
/* 801FC120 001F9120  98 8D 93 70 */	stb r4, lbl_80277C90@sda21(r13)
/* 801FC124 001F9124  90 0D 93 60 */	stw r0, lbl_80277C80@sda21(r13)
/* 801FC128 001F9128  93 CD 93 74 */	stw r30, lbl_80277C94@sda21(r13)
/* 801FC12C 001F912C  4B F7 A4 C1 */	bl AIRegisterDMACallback
/* 801FC130 001F9130  88 0D 93 70 */	lbz r0, lbl_80277C90@sda21(r13)
/* 801FC134 001F9134  38 80 02 80 */	li r4, 0x280
/* 801FC138 001F9138  80 6D 93 6C */	lwz r3, lbl_80277C8C@sda21(r13)
...
.global salAiGetDest
salAiGetDest:
/* 801FC1A8 001F91A8  88 6D 93 70 */	lbz r3, lbl_80277C90@sda21(r13)
/* 801FC1AC 001F91AC  80 8D 93 6C */	lwz r4, lbl_80277C8C@sda21(r13)
...
/* 801FC208 001F9208  A1 6D 86 B0 */	lhz r11, lbl_80276FD0@sda21(r13)
...
/* 801FC230 001F9230  38 6D 93 50 */	addi r3, r13, lbl_80277C70@sda21
...
/* 801FC27C 001F927C  90 0D 93 58 */	stw r0, lbl_80277C78@sda21(r13)
/* 801FC280 001F9280  48 00 01 19 */	bl hwEnableIrq
lbl_801FC284:
/* 801FC284 001F9284  80 0D 93 58 */	lwz r0, lbl_80277C78@sda21(r13)
...
/* 801FC2D4 001F92D4  83 ED 92 D8 */	lwz r31, lbl_80277BF8@sda21(r13)
/* 801FC2D8 001F92D8  90 0D 93 68 */	stw r0, lbl_80277C88@sda21(r13)
/* 801FC2DC 001F92DC  4B F6 8B 45 */	bl PPCSync
/* 801FC2E0 001F92E0  A0 0D 92 D4 */	lhz r0, lbl_80277BF4@sda21(r13)
...
/* 801FC340 001F9340  80 AD 93 5C */	lwz r5, lbl_80277C7C@sda21(r13)
...
/* 801FC380 001F9380  90 6D 93 48 */	stw r3, lbl_80277C68@sda21(r13)
/* 801FC384 001F9384  B0 0D 93 4C */	sth r0, lbl_80277C6C@sda21(r13)
...
/* 801FC3A4 001F93A4  A0 6D 93 4C */	lhz r3, lbl_80277C6C@sda21(r13)
/* 801FC3A8 001F93A8  38 63 FF FF */	addi r3, r3, -1
/* 801FC3AC 001F93AC  54 60 04 3F */	clrlwi. r0, r3, 0x10
/* 801FC3B0 001F93B0  B0 6D 93 4C */	sth r3, lbl_80277C6C@sda21(r13)
/* 801FC3B4 001F93B4  40 82 00 0C */	bne lbl_801FC3C0
/* 801FC3B8 001F93B8  80 6D 93 48 */	lwz r3, lbl_80277C68@sda21(r13)
