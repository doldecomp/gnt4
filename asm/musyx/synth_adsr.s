...
/* 801F0910 001ED910  C8 42 C7 90 */	lfd f2, lbl_8027C430@sda21(r2)
/* 801F0914 001ED914  90 01 00 14 */	stw r0, 0x14(r1)
/* 801F0918 001ED918  3C 00 43 30 */	lis r0, 0x4330
/* 801F091C 001ED91C  C0 62 C7 88 */	lfs f3, lbl_8027C428@sda21(r2)
/* 801F0920 001ED920  90 61 00 0C */	stw r3, 0xc(r1)
/* 801F0924 001ED924  C8 22 C7 80 */	lfd f1, lbl_8027C420@sda21(r2)
...
/* 801F0940 001ED940  C0 02 C7 8C */	lfs f0, lbl_8027C42C@sda21(r2)
/* 801F0944 001ED944  EC 20 00 72 */	fmuls f1, f0, f1
/* 801F0948 001ED948  4B F9 D8 0D */	bl __cvt_fp2unsigned
...
/* 801F0CA8 001EDCA8  C8 22 C7 90 */	lfd f1, lbl_8027C430@sda21(r2)
/* 801F0CAC 001EDCAC  90 61 00 0C */	stw r3, 0xc(r1)
/* 801F0CB0 001EDCB0  C0 62 C7 98 */	lfs f3, lbl_8027C438@sda21(r2)
...
/* 801F0CC0 001EDCC0  C8 22 C7 A0 */	lfd f1, lbl_8027C440@sda21(r2)
...
/* 801F0CD8 001EDCD8  4B F9 D4 7D */	bl __cvt_fp2unsigned
...
/* 801F0E0C 001EDE0C  C8 22 C7 90 */	lfd f1, lbl_8027C430@sda21(r2)
/* 801F0E10 001EDE10  90 61 00 0C */	stw r3, 0xc(r1)
/* 801F0E14 001EDE14  C0 62 C7 98 */	lfs f3, lbl_8027C438@sda21(r2)
...
/* 801F0E24 001EDE24  C8 22 C7 A0 */	lfd f1, lbl_8027C440@sda21(r2)
...
/* 801F0E3C 001EDE3C  4B F9 D3 19 */	bl __cvt_fp2unsigned
