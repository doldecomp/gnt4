...
.global wP_RunObjectFrameFunctions
wP_RunObjectFrameFunctions:
...
/* 801D903C 001D603C  4B FB 52 41 */	bl _savegpr_27
/* 801D9040 001D6040  80 6D 91 94 */	lwz r3, lbl_80277AB4@sda21(r13)
/* 801D9044 001D6044  38 03 00 01 */	addi r0, r3, 1
/* 801D9048 001D6048  2C 00 00 02 */	cmpwi r0, 2
/* 801D904C 001D604C  90 0D 91 94 */	stw r0, lbl_80277AB4@sda21(r13)
/* 801D9050 001D6050  40 81 00 0C */	ble lbl_801D905C
/* 801D9054 001D6054  38 00 00 00 */	li r0, 0
/* 801D9058 001D6058  90 0D 91 94 */	stw r0, lbl_80277AB4@sda21(r13)
lbl_801D905C:
...
/* 801D906C 001D606C  3B AD 91 60 */	addi r29, r13, lbl_80277A80@sda21
/* 801D9070 001D6070  48 00 01 0C */	b lbl_801D917C
lbl_801D9074:
/* 801D9074 001D6074  93 8D 91 8C */	stw r28, lbl_80277AAC@sda21(r13)
/* 801D9078 001D6078  80 6D 91 98 */	lwz r3, lbl_80277AB8@sda21(r13)
...
/* 801D9088 001D6088  80 8D 91 94 */	lwz r4, lbl_80277AB4@sda21(r13)
/* 801D908C 001D608C  90 0D 91 88 */	stw r0, lbl_80277AA8@sda21(r13)
...
/* 801D90C0 001D60C0  90 0D 91 74 */	stw r0, lbl_80277A94@sda21(r13)
/* 801D90C4 001D60C4  93 6D 91 90 */	stw r27, lbl_80277AB0@sda21(r13)
...
/* 801D90E8 001D60E8  90 AD 91 88 */	stw r5, lbl_80277AA8@sda21(r13)
...
/* 801D9110 001D6110  4B FF ED 59 */	bl zz_801d7e68_
...
/* 801D9134 001D6134  4B FF EE 1D */	bl zz_801d7f50_
lbl_801D9138:
...
/* 801D914C 001D614C  4B FF E6 B5 */	bl zz_801d7800_
lbl_801D9150:
...
/* 801D9160 001D6160  90 0D 91 74 */	stw r0, lbl_80277A94@sda21(r13)
/* 801D9164 001D6164  90 0D 91 90 */	stw r0, lbl_80277AB0@sda21(r13)
lbl_801D9168:
/* 801D9168 001D6168  83 6D 91 88 */	lwz r27, lbl_80277AA8@sda21(r13)
lbl_801D916C:
...
/* 801D918C 001D618C  4B FB 51 3D */	bl _restgpr_27
...
/* 801D91C4 001D61C4  4B FB 50 AD */	bl _savegpr_24
...
/* 801D9210 001D6210  80 6D 91 7C */	lwz r3, lbl_80277A9C@sda21(r13)
...
/* 801D9294 001D6294  4B FB 50 29 */	bl _restgpr_24
...
/* 801D92B0 001D62B0  38 6D 91 60 */	addi r3, r13, lbl_80277A80@sda21
...
/* 801D92C4 001D62C4  80 8D 91 7C */	lwz r4, lbl_80277A9C@sda21(r13)
...
/* 801D946C 001D646C  48 00 00 35 */	bl zz_801d94a0_
/* 801D9470 001D6470  38 83 00 01 */	addi r4, r3, 1
/* 801D9474 001D6474  98 6D 91 A3 */	stb r3, lbl_80277AC3@sda21(r13)
/* 801D9478 001D6478  98 8D 91 A2 */	stb r4, lbl_80277AC2@sda21(r13)
...
/* 801D9488 001D6488  98 0D 91 A1 */	stb r0, lbl_80277AC1@sda21(r13)
/* 801D948C 001D648C  98 8D 91 A0 */	stb r4, lbl_80277AC0@sda21(r13)
...
.global zz_801d94d8_
zz_801d94d8_:
/* 801D94D8 001D64D8  80 8D 86 90 */	lwz r4, lbl_80276FB0@sda21(r13)
/* 801D94DC 001D64DC  80 0D 86 94 */	lwz r0, lbl_80276FB4@sda21(r13)
...
/* 801D9500 001D6500  4B FF FF 59 */	bl zz_801d9458_
/* 801D9504 001D6504  80 7F 00 00 */	lwz r3, 0(r31)
/* 801D9508 001D6508  80 1F 00 04 */	lwz r0, 4(r31)
/* 801D950C 001D650C  90 6D 91 60 */	stw r3, lbl_80277A80@sda21(r13)
/* 801D9510 001D6510  90 0D 91 64 */	stw r0, lbl_80277A84@sda21(r13)
...
/* 801D9520 001D6520  4B FF 1E 1D */	bl HSD_Alloc
/* 801D9524 001D6524  90 6D 91 84 */	stw r3, lbl_80277AA4@sda21(r13)
...
/* 801D9580 001D6580  4B FF 1D BD */	bl HSD_Alloc
/* 801D9584 001D6584  90 6D 91 7C */	stw r3, lbl_80277A9C@sda21(r13)
...
/* 801D95E0 001D65E0  4B FF 1D 5D */	bl HSD_Alloc
/* 801D95E4 001D65E4  38 C0 00 00 */	li r6, 0
/* 801D95E8 001D65E8  90 6D 91 98 */	stw r3, lbl_80277AB8@sda21(r13)
/* 801D95EC 001D65EC  7C C4 33 78 */	mr r4, r6
/* 801D95F0 001D65F0  7C C0 33 78 */	mr r0, r6
/* 801D95F4 001D65F4  48 00 00 14 */	b lbl_801D9608
lbl_801D95F8:
/* 801D95F8 001D65F8  80 6D 91 98 */	lwz r3, lbl_80277AB8@sda21(r13)
...
/* 801D9628 001D6628  4B FF 1D 15 */	bl HSD_Alloc
/* 801D962C 001D662C  38 E0 00 00 */	li r7, 0
/* 801D9630 001D6630  90 6D 91 9C */	stw r3, lbl_80277ABC@sda21(r13)
/* 801D9634 001D6634  7C E6 3B 78 */	mr r6, r7
/* 801D9638 001D6638  7C E5 3B 78 */	mr r5, r7
/* 801D963C 001D663C  48 00 00 14 */	b lbl_801D9650
lbl_801D9640:
/* 801D9640 001D6640  80 6D 91 9C */	lwz r3, lbl_80277ABC@sda21(r13)
...
/* 801D967C 001D667C  4B FE E1 15 */	bl HSD_ObjAllocInit
...
/* 801D9690 001D6690  4B FE E1 01 */	bl HSD_ObjAllocInit
...
/* 801D96C0 001D66C0  4B FF 1C 7D */	bl HSD_Alloc
/* 801D96C4 001D66C4  90 6D 91 68 */	stw r3, lbl_80277A88@sda21(r13)
...
/* 801D96EC 001D66EC  80 6D 91 68 */	lwz r3, lbl_80277A88@sda21(r13)
...
/* 801D9724 001D6724  90 0D 91 68 */	stw r0, lbl_80277A88@sda21(r13)
lbl_801D9728:
/* 801D9728 001D6728  38 00 00 00 */	li r0, 0
/* 801D972C 001D672C  3C 60 80 25 */	lis r3, lbl_8024DBA8@ha
/* 801D9730 001D6730  90 0D 91 94 */	stw r0, lbl_80277AB4@sda21(r13)
/* 801D9734 001D6734  90 0D 91 74 */	stw r0, lbl_80277A94@sda21(r13)
/* 801D9738 001D6738  90 0D 91 90 */	stw r0, lbl_80277AB0@sda21(r13)
/* 801D973C 001D673C  90 03 DB A8 */	stw r0, lbl_8024DBA8@l(r3)
/* 801D9740 001D6740  90 0D 91 70 */	stw r0, lbl_80277A90@sda21(r13)
/* 801D9744 001D6744  90 0D 91 6C */	stw r0, lbl_80277A8C@sda21(r13)
