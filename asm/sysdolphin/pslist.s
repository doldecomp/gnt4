...
/* 801A6EE0 001A3EE0  90 0D 8F 80 */	stw r0, lbl_802778A0@sda21(r13)
...
/* 801A6EF0 001A3EF0  48 02 44 4D */	bl HSD_Alloc
...
lbl_801A6F14:
/* 801A6F14 001A3F14  80 0D 8F 80 */	lwz r0, lbl_802778A0@sda21(r13)
/* 801A6F18 001A3F18  3B DE FF FF */	addi r30, r30, -1
/* 801A6F1C 001A3F1C  90 1F 00 00 */	stw r0, 0(r31)
/* 801A6F20 001A3F20  93 ED 8F 80 */	stw r31, lbl_802778A0@sda21(r13)
lbl_801A6F24:
...
/* 801A6F58 001A3F58  4B FE 73 21 */	bl _savegpr_26
/* 801A6F5C 001A3F5C  3C 80 80 25 */	lis r4, lbl_8024AD70@ha
/* 801A6F60 001A3F60  80 6D 8F 80 */	lwz r3, lbl_802778A0@sda21(r13)
...
/* 801A6F70 001A3F70  48 02 43 9D */	bl HSD_Free
...
/* 801A6F88 001A3F88  93 ED 8F 80 */	stw r31, lbl_802778A0@sda21(r13)
...
/* 801A6FA4 001A3FA4  48 02 43 69 */	bl HSD_Free
...
/* 801A6FDC 001A3FDC  4B FE 72 E9 */	bl _restgpr_26
...
/* 801A700C 001A400C  80 0D 8F 80 */	lwz r0, lbl_802778A0@sda21(r13)
...
/* 801A701C 001A401C  48 02 43 21 */	bl HSD_Alloc
/* 801A7020 001A4020  90 6D 8F 80 */	stw r3, lbl_802778A0@sda21(r13)
/* 801A7024 001A4024  38 80 00 00 */	li r4, 0
/* 801A7028 001A4028  38 A0 00 9C */	li r5, 0x9c
/* 801A702C 001A402C  4B E5 E4 B9 */	bl memset
lbl_801A7030:
/* 801A7030 001A4030  80 0D 8F 80 */	lwz r0, lbl_802778A0@sda21(r13)
...
lbl_801A7048:
/* 801A7048 001A4048  A0 8D 8E FE */	lhz r4, lbl_8027781E@sda21(r13)
/* 801A704C 001A404C  A0 0D 8E F8 */	lhz r0, lbl_80277818@sda21(r13)
/* 801A7050 001A4050  38 84 00 01 */	addi r4, r4, 1
/* 801A7054 001A4054  54 85 04 3E */	clrlwi r5, r4, 0x10
/* 801A7058 001A4058  B0 8D 8E FE */	sth r4, lbl_8027781E@sda21(r13)
/* 801A705C 001A405C  7C 05 00 40 */	cmplw r5, r0
/* 801A7060 001A4060  40 81 00 08 */	ble lbl_801A7068
/* 801A7064 001A4064  B0 AD 8E F8 */	sth r5, lbl_80277818@sda21(r13)
lbl_801A7068:
/* 801A7068 001A4068  80 03 00 00 */	lwz r0, 0(r3)
/* 801A706C 001A406C  28 1E 00 00 */	cmplwi r30, 0
/* 801A7070 001A4070  90 0D 8F 80 */	stw r0, lbl_802778A0@sda21(r13)
...
/* 801A7134 001A4134  48 02 EC B1 */	bl __assert
lbl_801A7138:
...
/* 801A716C 001A416C  48 02 EC 79 */	bl __assert
lbl_801A7170:
/* 801A7170 001A4170  80 1F 00 00 */	lwz r0, 0(r31)
/* 801A7174 001A4174  90 1E 00 00 */	stw r0, 0(r30)
lbl_801A7178:
/* 801A7178 001A4178  80 0D 8F 80 */	lwz r0, lbl_802778A0@sda21(r13)
/* 801A717C 001A417C  90 1F 00 00 */	stw r0, 0(r31)
/* 801A7180 001A4180  A0 6D 8E FE */	lhz r3, lbl_8027781E@sda21(r13)
/* 801A7184 001A4184  93 ED 8F 80 */	stw r31, lbl_802778A0@sda21(r13)
/* 801A7188 001A4188  38 03 FF FF */	addi r0, r3, -1
/* 801A718C 001A418C  B0 0D 8E FE */	sth r0, lbl_8027781E@sda21(r13)
...
/* 801A71EC 001A41EC  48 02 EB F9 */	bl __assert
lbl_801A71F0:
...
/* 801A7224 001A4224  4B FE 70 55 */	bl _savegpr_26
...
/* 801A7538 001A4538  4B FE 6D 8D */	bl _restgpr_26
