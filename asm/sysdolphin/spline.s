...
/* 801C4F1C 001C1F1C  C0 02 C4 7C */	lfs f0, lbl_8027C11C@sda21(r2)
/* 801C4F20 001C1F20  ED 41 00 72 */	fmuls f10, f1, f1
/* 801C4F24 001C1F24  C1 02 C4 78 */	lfs f8, lbl_8027C118@sda21(r2)
/* 801C4F28 001C1F28  C0 E2 C4 80 */	lfs f7, lbl_8027C120@sda21(r2)
...
/* 801C4FBC 001C1FBC  C8 62 C4 98 */	lfd f3, lbl_8027C138@sda21(r2)
...
/* 801C5070 001C2070  C0 02 C4 7C */	lfs f0, lbl_8027C11C@sda21(r2)
...
/* 801C5114 001C2114  C0 22 C4 8C */	lfs f1, lbl_8027C12C@sda21(r2)
/* 801C5118 001C2118  C1 22 C4 7C */	lfs f9, lbl_8027C11C@sda21(r2)
/* 801C511C 001C211C  ED 80 10 28 */	fsubs f12, f0, f2
/* 801C5120 001C2120  C1 62 C4 84 */	lfs f11, lbl_8027C124@sda21(r2)
...
/* 801C5134 001C2134  C0 E2 C4 88 */	lfs f7, lbl_8027C128@sda21(r2)
...
/* 801C51E4 001C21E4  C0 62 C4 7C */	lfs f3, lbl_8027C11C@sda21(r2)
/* 801C51E8 001C21E8  1C 06 00 0C */	mulli r0, r6, 0xc
/* 801C51EC 001C21EC  C1 42 C4 78 */	lfs f10, lbl_8027C118@sda21(r2)
...
/* 801C5340 001C2340  C0 C2 C4 84 */	lfs f6, lbl_8027C124@sda21(r2)
...
/* 801C5350 001C2350  C0 A2 C4 7C */	lfs f5, lbl_8027C11C@sda21(r2)
...
/* 801C540C 001C240C  C0 02 C4 B8 */	lfs f0, lbl_8027C158@sda21(r2)
/* 801C5410 001C2410  38 00 00 07 */	li r0, 7
/* 801C5414 001C2414  94 21 FF E0 */	stwu r1, -0x20(r1)
/* 801C5418 001C2418  C0 82 C4 90 */	lfs f4, lbl_8027C130@sda21(r2)
...
/* 801C5450 001C2450  C0 C2 C4 90 */	lfs f6, lbl_8027C130@sda21(r2)
...
/* 801C5474 001C2474  C0 A2 C4 A0 */	lfs f5, lbl_8027C140@sda21(r2)
...
lbl_801C5484:
/* 801C5484 001C2484  C0 A2 C4 90 */	lfs f5, lbl_8027C130@sda21(r2)
...
/* 801C5494 001C2494  C9 02 C4 A8 */	lfd f8, lbl_8027C148@sda21(r2)
/* 801C5498 001C2498  C8 E2 C4 B0 */	lfd f7, lbl_8027C150@sda21(r2)
...
lbl_801C54DC:
/* 801C54DC 001C24DC  C0 A2 C4 88 */	lfs f5, lbl_8027C128@sda21(r2)
...
/* 801C5504 001C2504  C0 C2 C4 90 */	lfs f6, lbl_8027C130@sda21(r2)
...
/* 801C5528 001C2528  C0 A2 C4 A0 */	lfs f5, lbl_8027C140@sda21(r2)
...
lbl_801C5538:
/* 801C5538 001C2538  C0 A2 C4 90 */	lfs f5, lbl_8027C130@sda21(r2)
...
/* 801C5548 001C2548  C9 02 C4 A8 */	lfd f8, lbl_8027C148@sda21(r2)
/* 801C554C 001C254C  C8 E2 C4 B0 */	lfd f7, lbl_8027C150@sda21(r2)
...
lbl_801C5590:
/* 801C5590 001C2590  C0 A2 C4 78 */	lfs f5, lbl_8027C118@sda21(r2)
...
/* 801C55C0 001C25C0  C0 A2 C4 90 */	lfs f5, lbl_8027C130@sda21(r2)
...
/* 801C55E4 001C25E4  C0 22 C4 A0 */	lfs f1, lbl_8027C140@sda21(r2)
...
lbl_801C55F4:
/* 801C55F4 001C25F4  C0 22 C4 90 */	lfs f1, lbl_8027C130@sda21(r2)
...
/* 801C5604 001C2604  C8 E2 C4 A8 */	lfd f7, lbl_8027C148@sda21(r2)
/* 801C5608 001C2608  C8 C2 C4 B0 */	lfd f6, lbl_8027C150@sda21(r2)
...
/* 801C5668 001C2668  C0 A2 C4 90 */	lfs f5, lbl_8027C130@sda21(r2)
...
/* 801C568C 001C268C  C0 22 C4 A0 */	lfs f1, lbl_8027C140@sda21(r2)
...
lbl_801C569C:
/* 801C569C 001C269C  C0 22 C4 90 */	lfs f1, lbl_8027C130@sda21(r2)
...
/* 801C56AC 001C26AC  C8 C2 C4 A8 */	lfd f6, lbl_8027C148@sda21(r2)
/* 801C56B0 001C26B0  C8 A2 C4 B0 */	lfd f5, lbl_8027C150@sda21(r2)
...
/* 801C56F8 001C26F8  C0 02 C4 7C */	lfs f0, lbl_8027C11C@sda21(r2)
...
/* 801C5760 001C2760  C3 82 C4 90 */	lfs f28, lbl_8027C130@sda21(r2)
/* 801C5764 001C2764  7C 7D 1B 78 */	mr r29, r3
/* 801C5768 001C2768  C3 62 C4 80 */	lfs f27, lbl_8027C120@sda21(r2)
...
/* 801C57FC 001C27FC  C3 E2 C4 C0 */	lfs f31, lbl_8027C160@sda21(r2)
/* 801C5800 001C2800  EC 01 00 28 */	fsubs f0, f1, f0
/* 801C5804 001C2804  C3 A2 C4 BC */	lfs f29, lbl_8027C15C@sda21(r2)
/* 801C5808 001C2808  C3 C2 C4 90 */	lfs f30, lbl_8027C130@sda21(r2)
...
/* 801C587C 001C287C  C8 62 C4 98 */	lfd f3, lbl_8027C138@sda21(r2)
/* 801C5880 001C2880  90 81 00 0C */	stw r4, 0xc(r1)
/* 801C5884 001C2884  C0 02 C4 80 */	lfs f0, lbl_8027C120@sda21(r2)
