...
/* 801A69E0 001A39E0  B0 0D 8E FA */	sth r0, lbl_8027781A@sda21(r13)
/* 801A69E4 001A39E4  B0 0D 8E F4 */	sth r0, lbl_80277814@sda21(r13)
/* 801A69E8 001A39E8  B3 CD 8F 78 */	sth r30, lbl_80277898@sda21(r13)
/* 801A69EC 001A39EC  90 0D 8F 7C */	stw r0, lbl_8027789C@sda21(r13)
...
/* 801A6A18 001A3A18  80 0D 8F 7C */	lwz r0, lbl_8027789C@sda21(r13)
/* 801A6A1C 001A3A1C  3B BD 00 01 */	addi r29, r29, 1
/* 801A6A20 001A3A20  90 1F 00 00 */	stw r0, 0(r31)
/* 801A6A24 001A3A24  93 ED 8F 7C */	stw r31, lbl_8027789C@sda21(r13)
lbl_801A6A28:
...
/* 801A6A64 001A3A64  80 6D 8F 7C */	lwz r3, lbl_8027789C@sda21(r13)
...
/* 801A6A84 001A3A84  90 0D 8F 7C */	stw r0, lbl_8027789C@sda21(r13)
...
/* 801A6ABC 001A3ABC  80 0D 8F 7C */	lwz r0, lbl_8027789C@sda21(r13)
...
/* 801A6ACC 001A3ACC  A0 6D 8F 78 */	lhz r3, lbl_80277898@sda21(r13)
/* 801A6AD0 001A3AD0  48 02 48 6D */	bl HSD_Alloc
/* 801A6AD4 001A3AD4  28 03 00 00 */	cmplwi r3, 0
/* 801A6AD8 001A3AD8  90 6D 8F 7C */	stw r3, lbl_8027789C@sda21(r13)
/* 801A6ADC 001A3ADC  41 82 00 10 */	beq lbl_801A6AEC
/* 801A6AE0 001A3AE0  A0 AD 8F 78 */	lhz r5, lbl_80277898@sda21(r13)
/* 801A6AE4 001A3AE4  38 80 00 00 */	li r4, 0
/* 801A6AE8 001A3AE8  4B E5 E9 FD */	bl memset
lbl_801A6AEC:
/* 801A6AEC 001A3AEC  80 6D 8F 7C */	lwz r3, lbl_8027789C@sda21(r13)
...
/* 801A6B04 001A3B04  C0 22 C2 30 */	lfs f1, lbl_8027BED0@sda21(r2)
/* 801A6B08 001A3B08  90 AD 8F 7C */	stw r5, lbl_8027789C@sda21(r13)
/* 801A6B0C 001A3B0C  C0 02 C2 34 */	lfs f0, lbl_8027BED4@sda21(r2)
...
/* 801A6B54 001A3B54  A0 8D 8E FA */	lhz r4, lbl_8027781A@sda21(r13)
/* 801A6B58 001A3B58  A0 0D 8E F4 */	lhz r0, lbl_80277814@sda21(r13)
/* 801A6B5C 001A3B5C  38 84 00 01 */	addi r4, r4, 1
/* 801A6B60 001A3B60  54 85 04 3E */	clrlwi r5, r4, 0x10
/* 801A6B64 001A3B64  B0 8D 8E FA */	sth r4, lbl_8027781A@sda21(r13)
/* 801A6B68 001A3B68  7C 05 00 40 */	cmplw r5, r0
/* 801A6B6C 001A3B6C  40 81 00 08 */	ble lbl_801A6B74
/* 801A6B70 001A3B70  B0 AD 8E F4 */	sth r5, lbl_80277814@sda21(r13)
lbl_801A6B74:
...
lbl_801A6D44:
/* 801A6D44 001A3D44  80 0D 8F 7C */	lwz r0, lbl_8027789C@sda21(r13)
/* 801A6D48 001A3D48  90 1F 00 00 */	stw r0, 0(r31)
/* 801A6D4C 001A3D4C  A0 6D 8E FA */	lhz r3, lbl_8027781A@sda21(r13)
/* 801A6D50 001A3D50  93 ED 8F 7C */	stw r31, lbl_8027789C@sda21(r13)
/* 801A6D54 001A3D54  38 03 FF FF */	addi r0, r3, -1
/* 801A6D58 001A3D58  B0 0D 8E FA */	sth r0, lbl_8027781A@sda21(r13)
lbl_801A6D5C:
...
lbl_801A6DFC:
/* 801A6DFC 001A3DFC  80 0D 8F 7C */	lwz r0, lbl_8027789C@sda21(r13)
/* 801A6E00 001A3E00  90 1F 00 00 */	stw r0, 0(r31)
/* 801A6E04 001A3E04  A0 6D 8E FA */	lhz r3, lbl_8027781A@sda21(r13)
/* 801A6E08 001A3E08  93 ED 8F 7C */	stw r31, lbl_8027789C@sda21(r13)
/* 801A6E0C 001A3E0C  38 03 FF FF */	addi r0, r3, -1
/* 801A6E10 001A3E10  B0 0D 8E FA */	sth r0, lbl_8027781A@sda21(r13)
lbl_801A6E14:
