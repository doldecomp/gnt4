...
/* 80178A08 00175A08  80 0D 8D D4 */	lwz r0, lbl_802776F4@sda21(r13)
/* 80178A0C 00175A0C  28 00 00 00 */	cmplwi r0, 0
/* 80178A10 00175A10  40 82 00 1C */	bne lbl_80178A2C
/* 80178A14 00175A14  80 6D 8D C8 */	lwz r3, lbl_802776E8@sda21(r13)
/* 80178A18 00175A18  28 03 00 00 */	cmplwi r3, 0
/* 80178A1C 00175A1C  41 82 00 10 */	beq lbl_80178A2C
/* 80178A20 00175A20  90 6D 8D D4 */	stw r3, lbl_802776F4@sda21(r13)
/* 80178A24 00175A24  80 03 00 00 */	lwz r0, 0(r3)
/* 80178A28 00175A28  90 0D 8D C8 */	stw r0, lbl_802776E8@sda21(r13)
lbl_80178A2C:
/* 80178A2C 00175A2C  80 AD 8D D4 */	lwz r5, lbl_802776F4@sda21(r13)
...
/* 80178A3C 00175A3C  80 0D 8D E0 */	lwz r0, lbl_80277700@sda21(r13)
...
/* 80178A5C 00175A5C  4B FF E5 09 */	bl ARStartDMA
...
/* 80178A6C 00175A6C  4B FF E4 F9 */	bl ARStartDMA
lbl_80178A70:
/* 80178A70 00175A70  80 6D 8D D4 */	lwz r3, lbl_802776F4@sda21(r13)
/* 80178A74 00175A74  80 03 00 1C */	lwz r0, 0x1c(r3)
/* 80178A78 00175A78  90 0D 8D DC */	stw r0, lbl_802776FC@sda21(r13)
...
/* 80178A98 00175A98  4B FF E4 CD */	bl ARStartDMA
...
/* 80178AAC 00175AAC  4B FF E4 B9 */	bl ARStartDMA
lbl_80178AB0:
/* 80178AB0 00175AB0  80 6D 8D D4 */	lwz r3, lbl_802776F4@sda21(r13)
/* 80178AB4 00175AB4  80 8D 8D E0 */	lwz r4, lbl_80277700@sda21(r13)
...
/* 80178AC4 00175AC4  80 8D 8D D4 */	lwz r4, lbl_802776F4@sda21(r13)
/* 80178AC8 00175AC8  80 0D 8D E0 */	lwz r0, lbl_80277700@sda21(r13)
...
/* 80178AD8 00175AD8  80 8D 8D D4 */	lwz r4, lbl_802776F4@sda21(r13)
/* 80178ADC 00175ADC  80 0D 8D E0 */	lwz r0, lbl_80277700@sda21(r13)
...
/* 80178B0C 00175B0C  81 8D 8D D8 */	lwz r12, lbl_802776F8@sda21(r13)
/* 80178B10 00175B10  28 0C 00 00 */	cmplwi r12, 0
/* 80178B14 00175B14  41 82 00 20 */	beq lbl_80178B34
/* 80178B18 00175B18  80 6D 8D D0 */	lwz r3, lbl_802776F0@sda21(r13)
/* 80178B1C 00175B1C  7D 88 03 A6 */	mtlr r12
/* 80178B20 00175B20  4E 80 00 21 */	blrl 
/* 80178B24 00175B24  38 00 00 00 */	li r0, 0
/* 80178B28 00175B28  90 0D 8D D0 */	stw r0, lbl_802776F0@sda21(r13)
/* 80178B2C 00175B2C  90 0D 8D D8 */	stw r0, lbl_802776F8@sda21(r13)
/* 80178B30 00175B30  48 00 00 28 */	b lbl_80178B58
lbl_80178B34:
/* 80178B34 00175B34  81 8D 8D DC */	lwz r12, lbl_802776FC@sda21(r13)
/* 80178B38 00175B38  28 0C 00 00 */	cmplwi r12, 0
/* 80178B3C 00175B3C  41 82 00 1C */	beq lbl_80178B58
/* 80178B40 00175B40  80 6D 8D D4 */	lwz r3, lbl_802776F4@sda21(r13)
/* 80178B44 00175B44  7D 88 03 A6 */	mtlr r12
/* 80178B48 00175B48  4E 80 00 21 */	blrl 
/* 80178B4C 00175B4C  38 00 00 00 */	li r0, 0
/* 80178B50 00175B50  90 0D 8D D4 */	stw r0, lbl_802776F4@sda21(r13)
/* 80178B54 00175B54  90 0D 8D DC */	stw r0, lbl_802776FC@sda21(r13)
lbl_80178B58:
/* 80178B58 00175B58  80 CD 8D C0 */	lwz r6, lbl_802776E0@sda21(r13)
...
/* 80178B7C 00175B7C  4B FF E3 E9 */	bl ARStartDMA
...
/* 80178B90 00175B90  4B FF E3 D5 */	bl ARStartDMA
lbl_80178B94:
/* 80178B94 00175B94  80 6D 8D C0 */	lwz r3, lbl_802776E0@sda21(r13)
/* 80178B98 00175B98  80 03 00 1C */	lwz r0, 0x1c(r3)
/* 80178B9C 00175B9C  90 0D 8D D8 */	stw r0, lbl_802776F8@sda21(r13)
/* 80178BA0 00175BA0  90 6D 8D D0 */	stw r3, lbl_802776F0@sda21(r13)
/* 80178BA4 00175BA4  80 03 00 00 */	lwz r0, 0(r3)
/* 80178BA8 00175BA8  90 0D 8D C0 */	stw r0, lbl_802776E0@sda21(r13)
lbl_80178BAC:
/* 80178BAC 00175BAC  80 0D 8D D0 */	lwz r0, lbl_802776F0@sda21(r13)
/* 80178BB0 00175BB0  28 00 00 00 */	cmplwi r0, 0
/* 80178BB4 00175BB4  40 82 00 08 */	bne lbl_80178BBC
/* 80178BB8 00175BB8  4B FF FE 45 */	bl __ARQServiceQueueLo
lbl_80178BBC:
...
/* 80178BDC 00175BDC  80 0D 8D E4 */	lwz r0, lbl_80277704@sda21(r13)
/* 80178BE0 00175BE0  2C 00 00 01 */	cmpwi r0, 1
/* 80178BE4 00175BE4  41 82 00 44 */	beq lbl_80178C28
/* 80178BE8 00175BE8  80 6D 81 D0 */	lwz r3, lbl_80276AF0@sda21(r13)
/* 80178BEC 00175BEC  4B FE CD B1 */	bl OSRegisterVersion
/* 80178BF0 00175BF0  3B E0 00 00 */	li r31, 0
/* 80178BF4 00175BF4  38 00 10 00 */	li r0, 0x1000
/* 80178BF8 00175BF8  93 ED 8D C8 */	stw r31, lbl_802776E8@sda21(r13)
/* 80178BFC 00175BFC  3C 60 80 18 */	lis r3, __ARQInterruptServiceRoutine@ha
/* 80178C00 00175C00  93 ED 8D C0 */	stw r31, lbl_802776E0@sda21(r13)
/* 80178C04 00175C04  38 63 8B 00 */	addi r3, r3, __ARQInterruptServiceRoutine@l
/* 80178C08 00175C08  90 0D 8D E0 */	stw r0, lbl_80277700@sda21(r13)
/* 80178C0C 00175C0C  4B FF E3 15 */	bl ARRegisterDMACallback
/* 80178C10 00175C10  38 00 00 01 */	li r0, 1
/* 80178C14 00175C14  93 ED 8D D0 */	stw r31, lbl_802776F0@sda21(r13)
/* 80178C18 00175C18  93 ED 8D D4 */	stw r31, lbl_802776F4@sda21(r13)
/* 80178C1C 00175C1C  93 ED 8D D8 */	stw r31, lbl_802776F8@sda21(r13)
/* 80178C20 00175C20  93 ED 8D DC */	stw r31, lbl_802776FC@sda21(r13)
/* 80178C24 00175C24  90 0D 8D E4 */	stw r0, lbl_80277704@sda21(r13)
lbl_80178C28:
...
lbl_80178C88:
/* 80178C88 00175C88  3C 60 80 18 */	lis r3, __ARQCallbackHack@ha
/* 80178C8C 00175C8C  38 03 8A FC */	addi r0, r3, __ARQCallbackHack@l
/* 80178C90 00175C90  90 1D 00 1C */	stw r0, 0x1c(r29)
lbl_80178C94:
/* 80178C94 00175C94  4B FF 0E C5 */	bl OSDisableInterrupts
...
lbl_80178CB4:
/* 80178CB4 00175CB4  80 0D 8D C8 */	lwz r0, lbl_802776E8@sda21(r13)
/* 80178CB8 00175CB8  28 00 00 00 */	cmplwi r0, 0
/* 80178CBC 00175CBC  41 82 00 10 */	beq lbl_80178CCC
/* 80178CC0 00175CC0  80 6D 8D CC */	lwz r3, lbl_802776EC@sda21(r13)
/* 80178CC4 00175CC4  93 A3 00 00 */	stw r29, 0(r3)
/* 80178CC8 00175CC8  48 00 00 08 */	b lbl_80178CD0
lbl_80178CCC:
/* 80178CCC 00175CCC  93 AD 8D C8 */	stw r29, lbl_802776E8@sda21(r13)
lbl_80178CD0:
/* 80178CD0 00175CD0  93 AD 8D CC */	stw r29, lbl_802776EC@sda21(r13)
/* 80178CD4 00175CD4  48 00 00 24 */	b lbl_80178CF8
lbl_80178CD8:
/* 80178CD8 00175CD8  80 0D 8D C0 */	lwz r0, lbl_802776E0@sda21(r13)
/* 80178CDC 00175CDC  28 00 00 00 */	cmplwi r0, 0
/* 80178CE0 00175CE0  41 82 00 10 */	beq lbl_80178CF0
/* 80178CE4 00175CE4  80 6D 8D C4 */	lwz r3, lbl_802776E4@sda21(r13)
/* 80178CE8 00175CE8  93 A3 00 00 */	stw r29, 0(r3)
/* 80178CEC 00175CEC  48 00 00 08 */	b lbl_80178CF4
lbl_80178CF0:
/* 80178CF0 00175CF0  93 AD 8D C0 */	stw r29, lbl_802776E0@sda21(r13)
lbl_80178CF4:
/* 80178CF4 00175CF4  93 AD 8D C4 */	stw r29, lbl_802776E4@sda21(r13)
lbl_80178CF8:
/* 80178CF8 00175CF8  80 0D 8D D0 */	lwz r0, lbl_802776F0@sda21(r13)
/* 80178CFC 00175CFC  28 00 00 00 */	cmplwi r0, 0
/* 80178D00 00175D00  40 82 00 74 */	bne lbl_80178D74
/* 80178D04 00175D04  80 0D 8D D4 */	lwz r0, lbl_802776F4@sda21(r13)
/* 80178D08 00175D08  28 00 00 00 */	cmplwi r0, 0
/* 80178D0C 00175D0C  40 82 00 68 */	bne lbl_80178D74
/* 80178D10 00175D10  80 CD 8D C0 */	lwz r6, lbl_802776E0@sda21(r13)
...
/* 80178D34 00175D34  4B FF E2 31 */	bl ARStartDMA
...
/* 80178D48 00175D48  4B FF E2 1D */	bl ARStartDMA
lbl_80178D4C:
/* 80178D4C 00175D4C  80 6D 8D C0 */	lwz r3, lbl_802776E0@sda21(r13)
/* 80178D50 00175D50  80 03 00 1C */	lwz r0, 0x1c(r3)
/* 80178D54 00175D54  90 0D 8D D8 */	stw r0, lbl_802776F8@sda21(r13)
/* 80178D58 00175D58  90 6D 8D D0 */	stw r3, lbl_802776F0@sda21(r13)
/* 80178D5C 00175D5C  80 03 00 00 */	lwz r0, 0(r3)
/* 80178D60 00175D60  90 0D 8D C0 */	stw r0, lbl_802776E0@sda21(r13)
lbl_80178D64:
/* 80178D64 00175D64  80 0D 8D D0 */	lwz r0, lbl_802776F0@sda21(r13)
/* 80178D68 00175D68  28 00 00 00 */	cmplwi r0, 0
/* 80178D6C 00175D6C  40 82 00 08 */	bne lbl_80178D74
/* 80178D70 00175D70  4B FF FC 8D */	bl __ARQServiceQueueLo
lbl_80178D74:
/* 80178D74 00175D74  7F E3 FB 78 */	mr r3, r31
/* 80178D78 00175D78  4B FF 0E 09 */	bl OSRestoreInterrupts
