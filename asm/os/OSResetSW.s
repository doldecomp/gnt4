...
/* 8016AC58 00167C58  90 8D 8B D4 */	stw r4, lbl_802774F4@sda21(r13)
...
/* 8016AC68 00167C68  90 6D 8B D0 */	stw r3, lbl_802774F0@sda21(r13)
...
/* 8016AC8C 00167C8C  80 CD 8B D4 */	lwz r6, lbl_802774F4@sda21(r13)
/* 8016AC90 00167C90  6F C5 80 00 */	xoris r5, r30, 0x8000
/* 8016AC94 00167C94  80 0D 8B D0 */	lwz r0, lbl_802774F0@sda21(r13)
...
/* 8016ACD8 00167CD8  90 0D 8B BC */	stw r0, lbl_802774DC@sda21(r13)
/* 8016ACDC 00167CDC  38 60 02 00 */	li r3, 0x200
/* 8016ACE0 00167CE0  90 0D 8B C0 */	stw r0, lbl_802774E0@sda21(r13)
/* 8016ACE4 00167CE4  4B FF F2 3D */	bl __OSMaskInterrupts
/* 8016ACE8 00167CE8  81 8D 8B B8 */	lwz r12, lbl_802774D8@sda21(r13)
...
/* 8016ACFC 00167CFC  90 0D 8B B8 */	stw r0, lbl_802774D8@sda21(r13)
...
/* 8016AD60 00167D60  80 0D 8B BC */	lwz r0, lbl_802774DC@sda21(r13)
/* 8016AD64 00167D64  2C 00 00 00 */	cmpwi r0, 0
/* 8016AD68 00167D68  40 82 00 40 */	bne lbl_8016ADA8
/* 8016AD6C 00167D6C  80 0D 8B C8 */	lwz r0, lbl_802774E8@sda21(r13)
/* 8016AD70 00167D70  38 C0 00 00 */	li r6, 0
/* 8016AD74 00167D74  80 AD 8B CC */	lwz r5, lbl_802774EC@sda21(r13)
...
/* 8016AD84 00167D84  90 ED 8B BC */	stw r7, lbl_802774DC@sda21(r13)
...
lbl_8016AD98:
/* 8016AD98 00167D98  90 8D 8B D4 */	stw r4, lbl_802774F4@sda21(r13)
/* 8016AD9C 00167D9C  7C FD 3B 78 */	mr r29, r7
/* 8016ADA0 00167DA0  90 6D 8B D0 */	stw r3, lbl_802774F0@sda21(r13)
/* 8016ADA4 00167DA4  48 00 01 48 */	b lbl_8016AEEC
lbl_8016ADA8:
/* 8016ADA8 00167DA8  80 0D 8B C8 */	lwz r0, lbl_802774E8@sda21(r13)
/* 8016ADAC 00167DAC  39 20 00 00 */	li r9, 0
/* 8016ADB0 00167DB0  80 AD 8B CC */	lwz r5, lbl_802774EC@sda21(r13)
...
/* 8016ADCC 00167DCC  80 AD 8B D4 */	lwz r5, lbl_802774F4@sda21(r13)
...
/* 8016ADDC 00167DDC  80 0D 8B D0 */	lwz r0, lbl_802774F0@sda21(r13)
...
lbl_8016AE38:
/* 8016AE38 00167E38  80 0D 8B BC */	lwz r0, lbl_802774DC@sda21(r13)
/* 8016AE3C 00167E3C  2C 00 00 00 */	cmpwi r0, 0
/* 8016AE40 00167E40  41 82 00 34 */	beq lbl_8016AE74
/* 8016AE44 00167E44  80 AD 8B C0 */	lwz r5, lbl_802774E0@sda21(r13)
/* 8016AE48 00167E48  38 00 00 00 */	li r0, 0
/* 8016AE4C 00167E4C  90 0D 8B BC */	stw r0, lbl_802774DC@sda21(r13)
...
/* 8016AE5C 00167E5C  90 8D 8B CC */	stw r4, lbl_802774EC@sda21(r13)
/* 8016AE60 00167E60  90 6D 8B C8 */	stw r3, lbl_802774E8@sda21(r13)
/* 8016AE64 00167E64  48 00 00 88 */	b lbl_8016AEEC
lbl_8016AE68:
/* 8016AE68 00167E68  90 0D 8B CC */	stw r0, lbl_802774EC@sda21(r13)
/* 8016AE6C 00167E6C  90 0D 8B C8 */	stw r0, lbl_802774E8@sda21(r13)
/* 8016AE70 00167E70  48 00 00 7C */	b lbl_8016AEEC
lbl_8016AE74:
/* 8016AE74 00167E74  80 CD 8B C8 */	lwz r6, lbl_802774E8@sda21(r13)
/* 8016AE78 00167E78  39 00 00 00 */	li r8, 0
/* 8016AE7C 00167E7C  80 ED 8B CC */	lwz r7, lbl_802774EC@sda21(r13)
...
/* 8016AEE0 00167EE0  90 0D 8B CC */	stw r0, lbl_802774EC@sda21(r13)
/* 8016AEE4 00167EE4  3B A0 00 00 */	li r29, 0
/* 8016AEE8 00167EE8  90 0D 8B C8 */	stw r0, lbl_802774E8@sda21(r13)
lbl_8016AEEC:
/* 8016AEEC 00167EEC  3C A0 80 00 */	lis r5, 0x800030E3@ha
/* 8016AEF0 00167EF0  93 AD 8B C0 */	stw r29, lbl_802774E0@sda21(r13)
...
/* 8016AF08 00167F08  81 2D 8B 4C */	lwz r9, lbl_8027746C@sda21(r13)
/* 8016AF0C 00167F0C  81 0D 8B 48 */	lwz r8, lbl_80277468@sda21(r13)
